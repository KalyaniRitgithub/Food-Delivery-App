...
import com.example.fooddelivery.Adapter.FoodListAdapter;
import com.example.fooddelivery.Domain.Foods;
import com.example.fooddelivery.R;
import com.example.fooddelivery.databinding.ActivityListFoodBinding;
...
if(snapshot.exists()){
    ...
    binding.foodListView.setAdapter(new FoodListAdapter(list,ListFoodActivity.this));
...
binding.backBtn.setOnClickListener((View.OnClickListener) v -> finish());
